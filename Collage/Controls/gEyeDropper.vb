...
<ToolboxItem(True), ToolboxBitmap(GetType(gEyeDropper), "ColorPickerLib.gEyeDropper.bmp")> _
<Designer(GetType(gEyedropperDesigner))> _
<DefaultEvent("SelectedColorChanged")> _
 Public Class gEyeDropper
...
Public Class gEyedropperDesigner
