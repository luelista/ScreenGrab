Public Module sys_mwTrace
  Dim m_isIde As Byte = 0
  Private Const S = "|##|"


  Public Event TraceWrite(ByVal para1 As String, ByVal para2 As String, ByVal type As String, ByVal codeLink As String)
  Public Event PrintLineChanged(ByVal lineNumber As Integer, ByVal para1 As String, ByVal para2 As String, ByVal codeLink As String)
  ...
  Public Sub DumpException(ByVal para1 As String, ByVal ex As Exception, Optional ByVal typ As String = "err")
  ...
  Sub printLine(ByVal index As Integer, ByVal title As String, ByVal data As String, Optional ByVal pcodeLink As String = "")
    Dim codeLink As String
    If pcodeLink <> "" Then
      codeLink = pcodeLink
    Else
