...
Partial Class frm_paletteColor
    ...
    Me.GColorPicker1 = New ScreenGrab6.gColorPicker
    ...
    'GColorPicker1
    '
    Me.GColorPicker1.FlyOut = ScreenGrab6.gColorPicker.eFlyOut.Click
  ...
  End Sub
  Friend WithEvents GColorPicker1 As ScreenGrab6.gColorPicker
