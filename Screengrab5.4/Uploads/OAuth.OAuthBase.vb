...
#End Region
    ...
    Private Function GetQueryParameters(ByVal parameters As String) As SortedList(Of String, String)
    ...
    Protected Function NormalizeRequestParameters(ByVal parameters As SortedList(Of String, String)) As String
      ...
      For i = 0 To parameters.Count - 1
        p = parameters.Keys(i)
        sb.AppendFormat("{0}={1}", p, parameters(p))
    ...
    Public Function GenerateSignatureBase(ByVal url As Uri, ByVal consumerKey As String, ByVal token As String, ByVal tokenSecret As String, ByVal httpMethod As String, ByVal timeStamp As String, ByVal nonce As String, ByVal signatureType As String, ByVal additionalPostParameters As String, ByRef normalizedUrl As String, ByRef normalizedRequestParameters As String) As String
      ...
      Dim allParameters As SortedList(Of String, String) = GetQueryParameters(additionalPostParameters)
      ...
      Dim normalizedAllParameters = NormalizeRequestParameters(allParameters)

      Dim signatureBase As New StringBuilder()
      signatureBase.AppendFormat("{0}&", httpMethod.ToUpper())
      signatureBase.AppendFormat("{0}&", UrlEncode(normalizedUrl))
      signatureBase.AppendFormat("{0}", UrlEncode(normalizedAllParameters))
    ...
    ''' <param name="signatureType">The type of signature to use</param>
    ''' <returns>A base64 string of the hash value</returns>
    Public Function GenerateSignature(ByVal url As Uri, ByVal consumerKey As String, ByVal consumerSecret As String, ByVal token As String, ByVal tokenSecret As String, ByVal httpMethod As String, ByVal timeStamp As String, ByVal nonce As String, ByVal additionalPostParameters As String, ByVal signatureType As SignatureTypes, ByRef normalizedUrl As String, ByRef normalizedRequestParameters As String) As String
      normalizedUrl = Nothing
      normalizedRequestParameters = Nothing
      Select Case signatureType
        Case SignatureTypes.HMACSHA1
          Dim signatureBase As String = GenerateSignatureBase(url, consumerKey, token, tokenSecret, httpMethod, timeStamp, nonce, HMACSHA1SignatureType, additionalPostParameters, normalizedUrl, normalizedRequestParameters)
          Dim hmacsha1 As New HMACSHA1()
          hmacsha1.Key = Encoding.ASCII.GetBytes(String.Format("{0}&{1}", UrlEncode(consumerSecret), IIf(String.IsNullOrEmpty(tokenSecret), "", UrlEncode(tokenSecret))))
          Return GenerateSignatureUsingHash(signatureBase, hmacsha1)
        Case SignatureTypes.PLAINTEXT
