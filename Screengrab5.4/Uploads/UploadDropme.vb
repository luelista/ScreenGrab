Public Class UploadDropme
    ...
    Public Overrides Function runUpload(ByVal progressReceiver As IUploadOptionsPanel) As Boolean
        ...
        "--" & strBoundary & vbCrLf &
        "Content-Disposition: form-data; name=""key""" & vbCrLf &
        vbCrLf & "8b95f50a-959f-4684-8918-f3ab6fc7968a" &
        vbCrLf & "--" & strBoundary & vbCrLf &
        "Content-Disposition: form-data; name=""key""" & vbCrLf &
        vbCrLf & "8b95f50a-959f-4684-8918-f3ab6fc7968a" &
        vbCrLf & "--" & strBoundary & vbCrLf &
        "Content-Disposition: form-data; name=""username""" & vbCrLf &
        vbCrLf & glob.para("frm_options__txtLoginUser") &
        vbCrLf & "--" & strBoundary & vbCrLf &
        "Content-Disposition: form-data; name=""password""" & vbCrLf &
        vbCrLf & glob.para("frm_options__txtLoginPass") &
        vbCrLf & "--" & strBoundary & vbCrLf &
        "Content-Disposition: form-data; name=""uploaded""; filename=""" + filename + """" & vbCrLf &
