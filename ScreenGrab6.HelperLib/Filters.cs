...
namespace ScreenGrab6.CSharpFilters
{
    ...
    public void SetAll(int[] nValues)
    {
      TopLeft = nValues[0]; TopMid = nValues[1]; TopRight = nValues[2];
      MidLeft = nValues[3]; Pixel = nValues[4]; MidRight = nValues[5];
      BottomLeft = nValues[6]; BottomMid = nValues[7]; BottomRight = nValues[8]; 
    }
	}
