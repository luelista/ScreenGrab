...
namespace DirectoryBrowser
{
    ...
    internal class BrowserTVContextMenuWrapper : NativeWindow
    {
      ...
      private FolderBrowser br;
        ...
        public BrowserTVContextMenuWrapper(FolderBrowser br)
        {
            this.br = br;
    ...
    internal static class ContextMenuHelper
    {
        ...
        /// Ctrl + C and Ctrl + V.
        /// </summary>
        public static void ProcessKeyCommands(FolderBrowser br, object sender, KeyEventArgs e)
        {
