...
Namespace Vector
  ...
  <Microsoft.VisualBasic.ComClass()> Public Class Canvas
    ...
    Public ReadOnly Property Item(ByVal idx As Integer) As VObject
      Get
        Return p_objects(idx)
      End Get
    End Property
    Public ReadOnly Property ItemCount() As Integer
      Get
        Return p_objects.Count
      End Get
    End Property
    ...
    Function GetSelectionType() As String
      ...
      For Each pitem In selectedObjects
        Dim typeName = pitem.GetType.Name
    ...
    Sub CopySelection()
      ...
      For Each v In selectedObjects
        minX = Math.Min(minX, Math.Min(v.bounds.Right, v.Left) - v.BorderWidth / 2)
        minY = Math.Min(minY, Math.Min(v.bounds.Bottom, v.Top) - v.BorderWidth / 2)
        maxX = Math.Max(maxX, Math.Max(v.bounds.Right, v.Left) + v.BorderWidth / 2)
        maxY = Math.Max(maxY, Math.Max(v.bounds.Bottom, v.Top) + v.BorderWidth / 2)
      Next
    ...
    Sub readHtmlPage(ByVal fileSpec As String)
      ...
      While sr.EndOfStream = False
        ...
        If line.StartsWith("<!-- ##page##") Then
          ...
          If PicBox IsNot Nothing Then PicBox.BackColor = Helper.String2Color(para(5))
          'Me.Width = para(2)
          'Me.Height = para(3)
